    ...
    try {
        ...
        if (userDoc) {
            ...
            if (result) {
                ...
                res.json({ token: `Bearer ${token}`, message: "Login Successful", role: userDoc.role, id: userDoc._id ,fullName:userDoc.username,email:userDoc.email,Qualification:userDoc.qualification})
