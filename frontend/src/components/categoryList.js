...
//     // }
//     const handleClick=(activeCategory,issue)=>{
...
//                                             // onClick={redirect}
//                                             onClick={()=>{
//                                                 handleClick(activeCategory,issue)
//                                             }}
//                                         >
...
const NewCategoryList = () => {
  ...
  const handleClick = (activeCategory, issue) => {
    history.push({
      pathname: '/doctors',
      state: { activeCategory: categories[activeCategory], issue: issue }
    });
  };
          ...
          {activeCategory !== null && (
            <div className="tab-pane fade show active">
              ...
              <ul>
                {categories[activeCategory].healthIssues.map((issue, index) => (
                  <li key={index}>
                    <Button color="primary" outline onClick={() => handleClick(activeCategory, issue)}>
                      {issue.title} - Rs. {issue.price}
                    </Button>
                  </li>
                ))}
